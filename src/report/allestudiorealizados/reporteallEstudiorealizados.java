 ...
 */
package report.allestudiorealizados;

import report.TipoEstudios.*;
 ...
 * @author jeis
 */
public class reporteallEstudiorealizados {
        ...
        try {
            ...
            try {
                ...
                this.ruta = miDir.getCanonicalPath()
                        +"/src/report/allestudiorealizados/reporteallEstudioRealizado.jrxml";
